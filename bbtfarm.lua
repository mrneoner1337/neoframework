...
pcall(function() CoreGui:FindFirstChild("BABFTFarmNeo"):Destroy() end)
pcall(function() player.PlayerGui:FindFirstChild("BABFTFarmNeo"):Destroy() end)
...
task.delay(0.5, function()
	...
	if stages then
		...
		showNotification("Script Loaded", "BABFT Farm is ready!", "⛵", 3, Theme.Accent)
	else
